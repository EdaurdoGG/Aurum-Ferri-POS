            ...
            <div class="login">
                ...
                <form method="POST" enctype="multipart/form-data">
                    <div class="titulo">
                        ...
                        <a href="Clientes.php">
                            <img src="assets/icons/Volver.png" alt="Atrás" class="boton-atras">
                        </a>
                    </div>
                    ...
                    <div class="input-group">
                        <input type="tel" name="Telefono" pattern="[0-9]{10}" required value="<?= htmlspecialchars($cliente['Telefono']) ?>" placeholder=" ">
                    ...
                    <div class="input-group">
                        <input type="number" step="0.01" name="Credito" min="0" value="<?= htmlspecialchars($cliente['Credito']) ?>" placeholder=" ">
                        <label>Crédito</label>
                    </div>

                    <div class="input-group">
                        <input type="number" step="0.01" name="Limite" min="0" value="<?= htmlspecialchars($cliente['Limite']) ?>" placeholder=" ">
                        <label>Límite</label>
                    </div>

                    <button type="submit" name="ActualizarCliente" class="Acceder">
                        Actualizar
                    </button>
                </form>
