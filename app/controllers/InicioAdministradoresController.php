...
if (!empty($_POST['termino'])) {
    require_once __DIR__ . '/../helpers/AgregarProducto.php';
    exit();
}

/* ================= SUMAR / RESTAR ================= */
if (isset($_POST['sumar']) || isset($_POST['restar'])) {
    require_once __DIR__ . '/../helpers/ModificarCantidad.php';
    exit();
}

/* ================= ACTUALIZAR CANTIDAD ================= */
if (isset($_POST['actualizar'])) {
    require_once __DIR__ . '/../helpers/ActualizarCantidad.php';
    exit();
}

/* ================= PROCESAR VENTA ================= */
if (isset($_POST['procesar'])) {
    require_once __DIR__ . '/../helpers/ProcesarVenta.php';
    exit();
}
